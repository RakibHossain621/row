...
const ConfirmPrivateVideoModal: React.FC<ModalProps> = ({ isOpen, onClose, performerInfos, performerTotalFollowers }) => {
        ...
        <div ref={ref} role='dialog' className="w-full max-w-4xl max-h-full m-auto">
          <div className="bg-white rounded-lg shadow m-auto w-11/12 md:w-1/2">
            <header className="flex justify-between px-5 pt-4 rounded-t border-base-400">
              <h2 className="inline-flex items-center gap-x-4">
                ...
                <span className='text-xl text-black'>
                  Confirm your private video date
                </span>
              </h2>
            ...
            <footer className="w-full p-4 pb-6 text-right flex items-center flex-col md:flex-row gap-2 md:gap-0">
              <fieldset className="py-3 px-2 flex items-center justify-start md:justify-center gap-2 w-full order-1">
                <input 
                  ...
                  id="termsagree" 
                />
                <label className='text-left' htmlFor="termsagree">I agree to the <a href="#">Terms and Conditions</a></label>
              </fieldset>
              <AppButton 
                variant="tertiary" 
...
export default connect(mapState, mapDispatch)(ConfirmPrivateVideoModal);
