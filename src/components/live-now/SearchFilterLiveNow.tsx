...
interface IProps {
  ...
  activeTab: string
  handleSubmitOrdering: (e: ChangeEvent<HTMLSelectElement>) => void
}

export const SearchFilterLiveNow = ({
  ...
  return (
    <div className='relative w-auto py-4 md:pt-0 flex-1 flex flex-col justify-end items-center md:items-end gap-4'>
      ...
      <select 
        ...
        onChange={handleSubmitOrdering} 
        name="ordering" 
        id="modelOrdering"
      >
        <option defaultChecked value="">All</option>
        <option value="currentMonthViews">Online</option>
        <option value="views">Offline</option>
      </select> 
    </div>
  );
};