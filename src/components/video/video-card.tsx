...
import {
  EyeOutlined, LikeOutlined, HourglassOutlined, LockOutlined
      ...
      >
        ...
        >
          {video.isSale && video.price > 0 && (
            <span className="vid-price">
              <div className="label-price">
                <img alt="coin" src="/static/coins.png" width="15px" />
          ...
          <div className="vid-thumb">
            <div
              className="card-bg"
              style={{ backgroundImage: `url(${thumbUrl})`, filter: !canView ? 'blur(20px)' : 'blur(0px)' }}
            />
            ...
            <div className="lock-middle">
              {canView || isHovered ? '' : <LockOutlined />}
